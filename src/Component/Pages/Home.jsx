        ...
        <div>
            <div>
                <div className='relative'>
                    <div><Banner text1={'Upgrade Your Tech Accessorize with'} text2={'Gadget Heaven Accessories'} para={'Explore the latest gadgets that will take your experience to the next level. From smart devices to the coolest accessories, we have it all!'}></Banner>
